      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        <div className="relative flex flex-col items-center text-center lg:text-left lg:py-8 lg:items-start lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
          <h1 className="text-heading-1 text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-600 ml-2">
              with AI
            </span>
          </h1>
          <Paragraph className="mt-8">
            Step into a smarter future where your business adapts in real time,
            operates with intelligent automation, and makes decisions powered by data.
            Our AI platform makes this vision a reality—without disrupting your current tools.
          </Paragraph>
          ...
          <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
            <div className="flex sm:flex-row flex-col gap-5 w-full">
              ...
              >
                ...
                <input
                  type="email"
                  placeholder="Doremonmk01@gmail.com"
